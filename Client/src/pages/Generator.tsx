          ...
          <div className="w-full">
            <div className="mb-6">
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 text-white placeholder-gray-400 focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/20 outline-none transition-all duration-200"
              />
            </div>
            ...
            <div className="mb-6 text-gray-300">
              ...
              <div className="flex gap-4">
                ...
                <RectangleVerticalIcon
                  ...
                  className={`p-3 w-14 h-14 rounded-xl transition-all cursor-pointer border
        ${
          aspectRatio === "9:16"
            ? "ring-2 ring-violet-500/50 bg-white/10 border-violet-500/40"
